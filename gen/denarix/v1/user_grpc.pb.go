...
func (c *userServiceClient) SetGlobalAdmin(ctx context.Context, in *SetGlobalAdminRequest, opts ...grpc.CallOption) (*SetGlobalAdminResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetGlobalAdminResponse)
	err := c.cc.Invoke(ctx, UserService_SetGlobalAdmin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_SetGlobalAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetGlobalAdminRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).SetGlobalAdmin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_SetGlobalAdmin_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).SetGlobalAdmin(ctx, req.(*SetGlobalAdminRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "denarix.v1.UserService",
	...
	Metadata: "denarix/v1/user.proto",
}
